...
export const Homepage = () => {
  const { activities } = useHomepageState();
...
const ActivityItem = ({ activity }: { activity: IActivity }) => {
  ...
  return (
    <div className="px-4 py-3 border-b border-neutral-200 last:border-b-0 flex gap-4 items-center hover:opacity-100 cursor-pointer hover:bg-neutral-50">
      {renderIcon()}
